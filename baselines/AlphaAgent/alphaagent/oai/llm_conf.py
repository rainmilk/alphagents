...
class LLMSettings(ExtendedBaseSettings):
    ...
    # Chat configs
    openai_api_key: str = "sk-ve5dVPQ75DgivlLDKl1At0eac5MdYtwr1ztKqRsb78d9mQit"  # TODO: simplify the key design.
    openai_base_url: str = "http://35.220.164.252:3888/v1"
    chat_openai_api_key: str = ""
    chat_azure_api_base: str = ""
    chat_azure_api_version: str = ""
    chat_model: str = "bailian/deepseek-v4-flash"
    reasoning_model: str = ""
